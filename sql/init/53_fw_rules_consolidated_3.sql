...
CREATE TABLE IF NOT EXISTS fw_rules_consolidated_3 (
...
CREATE TABLE IF NOT EXISTS fw_rules_consolidated_3_sources (
...
CREATE TABLE IF NOT EXISTS fw_rules_consolidated_3_destinations (
  rule_id   BIGINT UNSIGNED NOT NULL,
